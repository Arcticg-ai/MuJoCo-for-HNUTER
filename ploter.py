...
def load_log_data(file_path: str) -> pd.DataFrame:
    ...
    # Convert radians to degrees (attitude and tilt angles)
    ...
    required_cols = [
        ...
        'alpha1_deg', 'alpha2_deg', 'theta1_deg', 'theta2_deg',
...
def plot_drone_data(df: pd.DataFrame, save_path: str = None):
    ...
    if save_path:
        ...
        save_path = f'logs/drone_analysis_{timestamp}.png'
        plt.savefig(save_path, dpi=300, bbox_inches='tight')
        print(f"Plot saved to: {save_path}")
